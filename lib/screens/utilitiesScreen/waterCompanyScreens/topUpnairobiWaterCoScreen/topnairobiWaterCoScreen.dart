...
class TopUpNairobiWaterCoScreen extends StatefulWidget {
  @override
  _TopUpNairobiWaterCoScreenState createState() => _TopUpNairobiWaterCoScreenState();
}

class _TopUpNairobiWaterCoScreenState extends State<TopUpNairobiWaterCoScreen> {
            ...
            Container(
              child: Padding(
                ...
                child: RaisedButton(
                  color: Colors.blue,
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>TopUpNairobiWaterCoSuccessScreen()));
                  },
                  child: Container(
