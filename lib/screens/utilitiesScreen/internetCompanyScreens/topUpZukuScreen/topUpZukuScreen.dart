...
import 'package:senty/screens/utilitiesScreen/internetCompanyScreens/topUpZukuScreen/topupZukuSuccessScreen.dart';
...
class TopUpZukuScreen extends StatefulWidget {
  @override
  _TopUpZukuScreenState createState() => _TopUpZukuScreenState();
}

class _TopUpZukuScreenState extends State<TopUpZukuScreen> {
            ...
            Container(
              child: Padding(
                ...
                child: RaisedButton(
                  color: Colors.blue,
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>TopUpZukuSuccessScreens()));
                  },
                  child: Container(
