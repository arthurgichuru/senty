...
import 'package:senty/screens/topUpScreen/TelkomScreens/topupTelkomSuccessScreen.dart';


class TopUpTelcomScreen extends StatefulWidget {
  @override
  _TopUpTelcomScreenState createState() => _TopUpTelcomScreenState();
}

class _TopUpTelcomScreenState extends State<TopUpTelcomScreen> {
            ...
            Container(
              child: Padding(
                ...
                child: RaisedButton(
                  color: Colors.blue,
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>TopupTelkomSuccessScreen()));
                  },
                  child: Container(
  ...
  void _handlePrePaid(int value) {
    setState(() {
      //_radioValue2 = value;
    });
  }

  void _handlePostPaid1(int value) {
    setState(() {
      _radioValue1 = value;
    });
  }
