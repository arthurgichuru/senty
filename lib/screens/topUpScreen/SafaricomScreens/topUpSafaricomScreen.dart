...
class TopUpSafaricomScreen extends StatefulWidget {
  @override
  _TopUpSafaricomScreenState createState() => _TopUpSafaricomScreenState();
}

class _TopUpSafaricomScreenState extends State<TopUpSafaricomScreen> {
            ...
            Container(
              child: Padding(
                ...
                child: RaisedButton(
                  color: Colors.blue,
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>TopUpSafaricomSuccessScreen()));
                  },
                  child: Container(
